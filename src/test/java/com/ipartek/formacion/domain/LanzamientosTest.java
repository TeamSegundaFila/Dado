...
public class LanzamientosTest {
	...
	public void testConstructorVacioLanzamientos() {
		...
		assertEquals("el id generado por constructor vacío no coincide con el obtenido por Getter, pero deberia", -1,
				lanzamientos.getId());
		assertTrue(
				"el nombre de lanzamientos generado por constructor vacío no coincide con el obtenido por Getter, pero deberia",
				"".equals(lanzamientos.getNombre()));
		assertTrue(
				"la fecha de lanzamientos generada por constructor vacío no coincide con el obtenido por Getter, pero deberia",
