...
public class UsuarioTest {
	...
	public void testConstructorVacioUsuario() {
		assertTrue(
				"el nombre de usuario generado por constructor vac�o no coincide con el obtenido por Getter, pero deberia",
		...
		assertEquals("el id generado por constructor vac�o no coincide con el obtenido por Getter, pero deberia", -1,
				usuario.getId());
		assertNull(
				"la fecha de alta generada por constructor vac�o (null) no coincide con la obtenida por Getter, pero deberia",
				usuario.getFechaAlta());
		assertNull(
				"la fecha de baja generada por constructor vac�o no coincide con la obtenida por Getter, pero deberia",
				usuario.getFechaBaja());
		assertNull(
				"la fecha de modificaci�n generada por constructor vac�o no coincide con la obtenida por Getter, pero deberia",
