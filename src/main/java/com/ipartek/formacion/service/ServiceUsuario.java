...
public interface ServiceUsuario {
	...
	/**
	 * M�todo que lista el total de usuarios guardados en la BBDD
	 * 
	...
	/**
	 * M�todo que devuelve el objeto Usuario de la BBDD, elegido al azar de
	...
	/**
	 * M�todo que devuelve un objeto Usuario de la BBDD, correspondiente al
	 * par�metro id que se le pasa como input
	...
	/**
	 * M�todo que pasa un objeto Usuario al DAO, para que cree una nueva entrada
	...
	/**
	 * M�todo que pasa un objeto Usuario al DAO, para que moddifique una entrada
	...
	/**
	 * M�todo que pasa un objeto Usuario al DAO, para que elimine una entrada
	...
	/**
	 * M�todo que pasa un objeto Usuario al DAO, para que de de baja una entrada
	 * preexistente de Usuario BBDD a partir de la variable long identificadora
	...
	/**
	 * M�todo que pasa un objeto Usuario al DAO, para que de de alta una entrada
	 * preexistente de Usuario BBDD a partir de la variable long identificadora
